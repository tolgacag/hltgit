...
const dataTable = {
  headerRow: ["Name", "Position", "Office", "Age", "Status", "Actions"],
  footerRow: ["Name", "Position", "Office", "Age", "Status", "Actions"],
  dataRows: [
    ["Tiger Nixon", "System Architect", "Edinburgh", "61","info"],
    ["Garrett Winters", "Accountant", "Tokyo", "63","warning"],
    ["Ashton Cox", "Junior Technical Author", "San Francisco", "66", "danger"],
    ["Cedric Kelly", "Senior Javascript Developer", "Edinburgh", "22","info"],
    ["Airi Satou", "Accountant", "Tokyo", "33","info"],
    ["Brielle Williamson", "Integration Specialist", "New York", "61", "danger"],
    ["Herrod Chandler", "Sales Assistant", "San Francisco", "59","info"],
    ["Rhona Davidson", "Integration Specialist", "Tokyo", "55","info"],
    ["Colleen Hurst", "Javascript Developer", "San Francisco", "39", "danger"],
    ["Sonya Frost", "Software Engineer", "Edinburgh", "23","info"],
    ["Jena Gaines", "Office Manager", "London", "30","info"],
    ["Quinn Flynn", "Support Lead", "Edinburgh", "22","info"],
    ["Charde Marshall", "Regional Director", "San Francisco", "36", "danger"],
    ["Haley Kennedy", "Senior Marketing Designer", "London", "43", "danger"],
    ["Tatyana Fitzpatrick", "Regional Director", "London", "19", "danger"],
    ["Michael Silva", "Marketing Designer", "London", "66","info"],
    ["Paul Byrd", "Chief Financial Officer (CFO)", "New York", "64"],
    ["Gloria Little", "Systems Administrator", "New York", "59", "danger"],
    ["Bradley Greer", "Software Engineer", "London", "41", "danger"],
    ["Dai Rios", "Personnel Lead", "Edinburgh", "35", "danger"],
    ["Jenette Caldwell", "Development Lead", "New York", "30", "danger"],
    ["Yuri Berry", "Chief Marketing Officer (CMO)", "New York", "40", "danger"],
    ["Caesar Vance", "Pre-Sales Support", "New York", "21","info"],
    ["Doris Wilder", "Sales Assistant", "Sidney", "23","info"],
    ["Angelica Ramos", "Chief Executive Officer (CEO)", "London", "47","info"],
    ["Gavin Joyce", "Developer", "Edinburgh", "42", "danger"],
    ["Jennifer Chang", "Regional Director", "Singapore", "28","info"],
    ["Brenden Wagner", "Software Engineer", "San Francisco", "28","info"],
    ["Fiona Green", "Chief Operating Officer (COO)", "San Francisco", "48","info"],
    ["Shou Itou", "Regional Marketing", "Tokyo", "20", "danger"],
    ["Michelle House", "Integration Specialist", "Sidney", "37", "danger"],
    ["Suki Burks", "Developer", "London", "53", "danger"],
    ["Prescott Bartlett", "Technical Author", "London", "27", "danger"],
    ["Gavin Cortez", "Team Leader", "San Francisco", "22", "danger"],
    ["Martena Mccray", "Post-Sales support", "Edinburgh", "46", "danger"],
    ["Unity Butler", "Marketing Designer", "San Francisco", "47", "danger"],
    ["Howard Hatfield", "Office Manager", "San Francisco", "51", "danger"],
    ["Hope Fuentes", "Secretary", "San Francisco", "41","info"],
    ["Vivian Harrell", "Financial Controller", "San Francisco", "62","info"],
    ["Timothy Mooney", "Office Manager", "London", "37","info"],
    ["Jackson Bradshaw", "Director", "New York", "65","info"],
    ["Olivia Liang", "Support Engineer", "Singapore", "64","info"]
  ]
};
