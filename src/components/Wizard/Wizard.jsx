...
class Wizard extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      finishTeklifButton: this.props.steps.length === 1 ? true : false,
      width: width,
      movingTabStyle: {
    ...
    this.finishTeklifButtonClick = this.finishTeklifButtonClick.bind(this);
    ...
    if (this.props.steps) {
      ...
      if (validationState) {
        this.setState({
          ...
          finishTeklifButton: this.props.steps.length === key + 1 ? true : false
        });
  ...
  finishTeklifButtonClick() {
    if (
      ...
      ((this[this.props.steps[this.state.currentStep].stepId].isValidated !==
        ...
        this[this.props.steps[this.state.currentStep].stepId].isValidated ===
          undefined) &&
      this.props.finishTeklifButtonClick !== undefined
    ) {
      this.props.finishTeklifButtonClick();
    }
  }
          ...
          <div className={classes.footer}>
            ...
            <div className={classes.right}>
              ...
              {this.state.finishButton ? (
                ...
                {this.state.finishTeklifButton ? (
                <Button
                color="success"
                className={this.finishButtonTeklifClasses}
                onClick={() => this.finishTeklifButtonClick()}
              >
                {this.props.finishTeklifButtonText}
              </Button>
              ) : null}
            </div>
...
Wizard.defaultProps = {
  ...
  finishButtonClasses: "",
  finishButtonText: "Kaydet",
  finishTeklifButtonText: "Teklif Oluştur"
};
...
Wizard.propTypes = {
  ...
  finishTeklifButtonClasses: PropTypes.string,
  finishTeklifButtonText: PropTypes.string,
  finishTeklifButtonClick: PropTypes.func,
